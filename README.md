...
|[Unicorn! · GitHub](https://juhanarossi.github.io/helsinki-nyc-days/)<br>:x: og:title<br>:x: og:description<br>:x: og:image<br>[how to fix](https://jonathansoma.com/everything/web/social-tags/)|request failed|request failed|request failed|
...
|[Unicorn! · GitHub](https://shalakas.github.io/blueberry-production-peru/)<br>:x: og:title<br>:x: og:description<br>:x: og:image<br>[how to fix](https://jonathansoma.com/everything/web/social-tags/)|request failed|request failed|request failed|
...
* Minimum font size should be 12px, enlarge text in Illustrator
    ...
    * *and 2 more*
* Overlapping elements in ai2html, check [the overflow video](https://www.youtube.com/watch?v=6vHsnjTp3_w) or make a smaller size
   * Text `9,831,000` overlaps with `Total:` at screen width 400
   * Text `Total:` overlaps with `11,194,000` at screen width 400
